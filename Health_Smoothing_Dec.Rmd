...
p1 <- ggplot() + geom_sf(color = 'grey', data = tract7) + geom_sf(aes(fill = ks_as), data=na.omit(tract7)) + 
...
p2 <- ggplot(data = tract7) + geom_sf(color = 'grey') + geom_sf(aes(fill = ks_as)) + 
  scale_fill_distiller(palette="Reds", trans = "reverse") + labs(title = 'Asthma')
...
p1 <- ggplot() + geom_sf(color = 'grey', data = tract7) + geom_sf(aes(fill = ks_mh), data=na.omit(tract7)) + 
...
p2 <- ggplot(data = tract7) + geom_sf(color = 'grey') + geom_sf(aes(fill = ks_mh)) + 
  scale_fill_distiller(palette="Blues", trans = "reverse") + labs(title = 'Mental Health')
grid.arrange(p1,p2, ncol = 2)
```
